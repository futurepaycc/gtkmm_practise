...
build = g++ -g  -I. `pkg-config --cflags-only-I --libs gtkmm-3.0` `pkg-config --cflags --libs webkit2gtk-4.0` `pkg-config --cflags --libs goocanvasmm-2.0` draw1.cpp -o bin/draw1
